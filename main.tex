...
%% TITLE
\Title{How to prepare your short paper for the scientific writing session}

%% AUTHORS
\AuthorName{Medeiros, V.S.}
\CorrEmail{viviano.medeiros@ct.ufpb.br}
\AdvisorName{Oliveira, G.P.}
%\CorrEmail{gustavo.oliveira@ci.ufpb.br}
\CoAdvisorName{} 
\Year{2019}
